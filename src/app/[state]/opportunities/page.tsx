            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <h1 className="text-xl font-bold font-display" style={{ color: 'var(--text-color)' }}>
                  {stateConfig.name} Priority Districts
                </h1>
                {isDemo('candidates') && (
                    ...
                    >
                      <td className="px-4 py-3">
                        <span className="font-medium" style={{ color: 'var(--text-color)' }}>
                          {chamber === 'house' ? stateConfig.chambers.house.name : stateConfig.chambers.senate.name} {district.districtNumber}
                        </span>
                      </td>
                      <td className="px-4 py-3">
                        <span
                      ...
                      <td className="px-4 py-3 text-right">
                        <Link
                          href={`/${stateCode.toLowerCase()}?chamber=${chamber}&district=${district.districtNumber}`}
